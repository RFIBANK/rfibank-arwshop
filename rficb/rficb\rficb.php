...
<form method="POST" accept-charset="$engineconf[charset]" action="https://partner.rficb.ru/a1lite/input/">
...
$default_language = $engineconf['lang'];
 if(! file_exists(PM_MODULES_DIR."/rficb/$admin_dir$default_language".'_lang.lng')){
...
$fh=fopen(PM_MODULES_DIR."/rficb/$admin_dir$default_language".'_lang.lng', "r") or die('Can\'t load language file!');
 while(! feof($fh)){
